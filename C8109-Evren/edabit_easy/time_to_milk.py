...
# so naturally we need to prepare some milk and cookies 
# for Santa! Create a function that accepts a Date object and 
...
import datetime
def time_for_milk_and_cookies(Eve):
    in_list = str(Eve).split("-")
    if ''.join(in_list[1:]) == "1224":
        print("True")
    else:
        print("False")
